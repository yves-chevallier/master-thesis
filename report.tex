...
\newglossaryentry{smart}{name=SMART, description={Singapore Alliance for search and technology}}
\newglossaryentry{tie}{name=TIE, description={Transport Intensity Equations}}
\newglossaryentry{vhis}{name=VHIS, description={Volume Holographic Imaging System}}
\newglossaryentry{ct}{name=CT, description={Computer Tomography}}
\newglossaryentry{epfl}{name=EPFL, description={Ecole Polytechnique Federale de Lausanne}}
\newglossaryentry{ro}{name=RO, description={Ashkin's Ray Optics Model}}
\newglossaryentry{doe}{name=DOE, description={Diffractive Optical Element}}
\newglossaryentry{slm}{name=SLM, description={Spatial Light Modulator}}
\newglossaryentry{oam}{name=OAM, description={Optical Angular Momentum}}
\newglossaryentry{qpd}{name=QPD, description={Quadrant Position Detector}}
\newglossaryentry{ics}{name=ICS, description={Infinite Corrected System}}
\newglossaryentry{hot}{name=HOT, description={Holographic Optical Tweezers}}
\newglossaryentry{tem}{name=TEM, description={Transverse Electromagnetic Mode}}
\newglossaryentry{ds}{name=DS, description={Direct Search Algorithm}}
\newglossaryentry{sr}{name=SR, description={Random Superposition Algorithm}}
\newglossaryentry{gs}{name=GS, description={Gerchberg-Saxton Algorithm}}
\newglossaryentry{rm}{name=RM, description={Random Mask}}
\newglossaryentry{s}{name=S, description={Superposition Algorithm}}
\newglossaryentry{cuda}{name=CUDA, description={Computer Unified Device Architecture}}
\newglossaryentry{easlm}{name=EASLM, description={Electrically Adressed SLM}}
\newglossaryentry{oaslm}{name=OASLM, description={Optically Adressed SLM}}
\newglossaryentry{lcos}{name=LCoS, description={Liquid Crystal on Silicon}}
\newglossaryentry{lc}{name=LC, description={Liquid Crystal}}
\newglossaryentry{ito}{name=ITO, description={Indium Tin Oxide}}
\newglossaryentry{fet}{name=FET, description={Field Effect Transistor}}
\newglossaryentry{dc}{name=DC, description={Direct Current}}
\newglossaryentry{dvi}{name=DVI, description={Digital Video Interface}}
\newglossaryentry{lut}{name=LUT, description={LookUp Table}}
\newglossaryentry{vh}{name=VH, description={Volume Holographic (system)}}
\newglossaryentry{eth}{name=ETH, description={Eidgenössische Technische Hochschule}}
\newglossaryentry{2pp}{name=2PP, description={Two Photons Photopolymerization}}
\newglossaryentry{tpa}{name=TPA, description={Two Photons Absorption}}
\newglossaryentry{uv}{name=UV, description={Ultra Violet}}
\newglossaryentry{peg}{name=PEG, description={PolyEthylene Glycol}}
\newglossaryentry{usaf}{name=USAF, description={United States Air Force}}
\newglossaryentry{fov}{name=FOV, description={Field Of View}}
\newglossaryentry{ccd}{name=CCD, description={Charged Coupled Device}}
...
\newglossaryentry{gsw}{name=GSW, description={Weighted Gerchberg-Saxton Algorithm}}
\newglossaryentry{gui}{name=GUI, description={Graphical User Interface}}
\newglossaryentry{gpl}{name=GPL, description={General Public License}}
\newglossaryentry{asm}{name=ASM, description={Assembly Programming Language}}
...
\newglossaryentry{cad}{name=CAD, description={Computer Assisted Drawing}}
...
% French
L'alliance MIT-Singapour pour la recherche et la technologie (SMART) ainsi que le  Massachusetts Institute of Technology (MIT) ont développé une nouvelle technique d'imagerie à plusieurs plans permettant la reconstruction d'objets de phase donc pratiquement transparents. Nous souhaitons à présent démontrer la faisabilité d'une reconstruction en trois dimensions, par tomographie, de cellules biologiques en utilisant des pincettes optiques, un domaine qui était jusqu'à lors peu connu de ces groupes de recherche. Des particules ont pu être capturées et tournées selon un axe perpendiculaire à l'axe optique. Nous souhaitons à présent réaliser un micro outil en SU-8 pour agripper  et orienter une cellule vivante. 
...
Prof. Christophe Moser from \gls{epfl} in Lausanne, \index{epfl}Switzerland contacted Prof. George Barbastathis of \gls{mit} 3D Optical Systems Group, in Boston, U.S., for my participation in this project and to pursue my master's thesis. I was invited to work for 25 weeks in Singapore under the responsibility of SMART and CENSAM, and to collaborate in a team consisting of Chen Zhi,  Wensheng Chen and Prof. Yuan Luo. 

\section{Context}
\maraja{Projected Tomography}
Tomography is a major imaging technology that allows for three-dimensional reconstruction by sectioning an object using a penetrating wave. Projected Tomography like Computed Tomography (\gls{ct}) uses X-rays to obtain an image projection through the matter. Often, the target or the imaging instrument needs to be rotated along a fixed axis in order to obtain multiple image projections. The post-treatment requires sophisticated algorithms including the Radon transform that allows building of a three-dimensional view from the cross-sectional scans of the object. 

In the microscopic world, Electron Tomography \index{electron tomography}is one of the available methods to image structures such as bacteria, biological cells or body tissues. An electron beam crossing the sample is partially absorbed depending on its composition. A sensor placed after the sample retrieves a cross-sectional projection for each angle. However this technique cannot be applied with a living specimen. The object needs to be scanned at a low temperature and this process takes time. 
...
Optical tweezers have proven their capabilities for moving, stretching and rotating microscopic living objects. A significant number of research groups have designed different solutions to rotate such objects. For example, in 2008, M. K. Kreysing \emph{et al.} from the University of Leipzig, Germany, used a modified dual-beam laser trap delivered by two optical fibers to rotate a \index{red blood cell} red blood cell around an axis perpendicular to the optical direction \cite{KREYSING2008}. Nevertheless, this solution is challenging to implement and is not very versatile due to the critical alignment of the two fibers. Therefore, this project will focus on the rotation of micro-organisms with standard optical tweezers. 

\clearpage
\section{Project goals}
Unlike other \gls{epfl} masters' projects, this project did not begin with specified goals. As with a research project, the objectives were changed many times following our weekly team meetings. As below are some of the goals which were eventually set in place:
...
As required by EPFL, this master's project will last for 25 weeks starting from September 17, 2011. The final report has to be submitted by the noon of March 16, 2012 and the oral presentation is scheduled to take place in early April. \index{oral presentation}
...
The second part deals with the volume hologram setup. The alignment \index{alignment} of this system is very sensitive and each component has to be assembled carefully. In addition, compromises must be made to combine the volume hologram system with the tweezers setup due to their stringent requirements. 
...
\maraja{Two parts}This report is mainly divided into two parts. The first part is a theoretical approach of optical trapping, volume holography and \index{micro-fabrication} micro-fabrication based on scientific publications and books. Most of the illustrations found in this portion are inspired from these readings but they were redrawn for better understanding and a better consistency. The second part is focused on experiments where results and issues are shown and explained. This part ends with a discussion of the results and suggests the possibility of further investigations. 

\maraja{Important remark}This report is not intended in any way to be published because its content relates scientific material which may be misused for competing on a scientific basis. In contrast, this report must be considered as a knowledge base for the continuation of this project. It reports the experience, the results and the thoughts acquired during this work. 
...
As early as the 17$^{\textrm{th}}$ century, Johannes Kepler noticed that light interacts with particles. In 1873, James Clerk Maxwell provided proof that light can exert a physical force on matter. This is a phenomenon known as radiation pressure which allowed for the possibility of utopian projects such as a solar sail. \index{radiation pressure}

\maraja{Arthur Ashkin}
The detection of optical \index{scattering force}\index{gradient force}scattering and gradient forces on micrometer sized particles was first reported in 1970 by Arthur Ashkin\index{Ashkin}, a scientist who worked at Bell Laboratories. His work was used a decade later by \index{Steven Chu}Steven Chu in a laser cooling technique called optical molasses that can cool down neutral atoms by slowing them down with laser light. This research earned Steven Chu the Nobel Prize in Physics in 1997. 
...
In 1987, Arthur Ashkin\index{Ashkin} and \index{Dziedzic}Joseph Martin Dziedzic demonstrated the first application of optical trapping applied to life sciences by publishing an article that showed a successful attempt to trap \index{virus}tobacco mosaic viruses and living Escherichia coli bacteria without any damage with an argon laser of tens of milli-watts \cite{ASHKIN1987}. Today, optical tweezers have emerged as an essential tool for the manipulation of biological cells by allowing sophisticated biophysical or bio-mechanical characterization. Besides showing that micrometer size particles can be moved, the principal advantage of optical tweezers explores the possibility of interacting with microorganisms without any physical contact. As a result, the risk of cross contamination is eliminated. Medical and scientific tools need to be well sterilized to avoid potential changes on the observed specimen. \index{contamination} 
...
\figc{stretch}{Deformation of a red blood cell}{Stretching a red blood cell with two silica spheres of 4.1 micrometers trapped with optical tweezers. We can observe the red blood cell in between}

\maraja{Force estimation}
Another important application is \index{force estimation}force estimation. Optical tweezers can become a microforce transducer or a tensometer when correctly calibrated. It is noteworthy to mention that optical forces have convincingly been calibrated down to \SI{25}{\femto\newton} on a \SI{0.53}{\um} latex bead \cite{ROHRBACH2005}. For example, an application of force measurement can be used on \index{spermatoza}spermatozoa which use mechanical force for motion. By trapping them and gradually releasing the power of the trap, we can measure the propulsion force of the zygote's tail. The same principle can be applied to Kinesin motors \cite{KUO1993} or other molecular\index{Kinesin motor} motors. \index{spermatozoa}

Without going into further details, it is worth noting other applications of optical tweezers in biology such as chromosome dissection, chromosome manipulation during mitosis, microsurgery and manipulation of cells \emph{in vivo}, controlled cell fusion or kinetic studies of DNA. \index{dna} 
...
In our case where the goal is to rotate a biological cell\index{cell}, the main forces involved are the gravitational and the buoyant forces which are proportional to the object size and in the range of few tens of pico Newtons. 

\section{Basic Principles}
\fig{tw}{ Basic principle of Optical Tweezers}

\maraja{Mie and Rayleigh scattering}
In this project, we will mainly focus on particles that scatter light in the Mie regime. That happens when a particle is bigger than the wavelength used. For instance, Mie scattering is responsible for the white appearance of clouds. In contrast, we can also consider particles in the \index{Rayleigh}Rayleigh regime when their \index{Mie}diameter is smaller than the wavelength of the light. Those two approaches are illustrated with figure \ref{mie}. Figure \ref{tw} shows the basic principle of optical tweezers: a transparent particle, herein a micro-sphere, trapped into a diffraction limited Gaussian beam. 
...
Ashkin \index{Ashkin} proposed a \index{ray optics model} ray optics model (\gls{ro}) \cite{ASHKIN1992} which was shown to be highly accurate for the prediction of axial forces and reasonably accurate for the prediction of the \index{transverse force}transverse forces in the case of microspheres bigger than $20\lambda$ \cite{WRIGHT1993}. For more accuracy, an electromagnetic-field model also exists. However, discrepancies between the measured forces and the theoretical models may indicate the presence of other forces such as radiometric forces (interactions of the particle with its surrounding). According to Ashkin\index{Ashkin}, we can note that the principal relationship between the trapping force and trapping power is: 
\begin{equation}
F = \frac{n Q P}{c}
\label{otforce}
\end{equation}
...
Optical \index{force} forces involved in optical trapping are in the range of pico Newtons which may be considered relatively small. However, if we consider a \SI{10}{\um} silica sphere of density of \SI{2.6}{\gram\cm^3}, its mass is only $\SI{1.3}{\nano\gram}$. The force needed to cancel the gravity force is about $\SI{13}{\pico\newton}$. Moreover, we do not consider here the buoyancy in the case of immersion of the particle. It is important to remember that the \emph{scale law} plays a very important role here. If the diameter of a particle is divided by a factor of 2, the force needed is divided by a factor of 8. Equation (\ref{force}) shows the relation between the diameter of a particle and its weight. Micro-structures do not follow the same rules as in our macroscopic world. \index{elephant}For instance, an ant if given the size of an elephant would not be able to stand on its thin legs. 
\begin{equation}
...
Due to the radiation pressure, the light will push a particle forward. This is known as the scattering force. However, the refraction inside the particle will change the light path, thus creating a so-called gradient force that pushes the particle back to the center of the trap. A balance of these two forces is the key component in holding the particle at the trap position. 

\section{Optical Forces for Mie particles}
\maraja{Ray Optics Model}
Ashkin made a proposition \index{mie} for the ray optics model to describe the forces for a sphere of size (> $10\lambda$). An incident ray that passes through the objective back aperture is focused to a spot on the focal plane of this objective. The maximum convergence angle $\alpha$ of the rays is determined by the numerical aperture of the microscope objective: $N.A.=n\cdot\sin\alpha$. When the ray strikes the particle that we consider here as a perfect transparent sphere of index of refraction $n_s$, a fraction of the momentum carried by the light is deflected by the refraction. We assume there is no absorption.
...
\label{forceinv}
\end{equation}
Hence, a simple two-light ray diagram can be used to explain the optical forces by a refractive micro sphere using Snell-Descartes law and assuming a focused\index{Gaussian} Gaussian laser beam. Figure \ref{ro} shows the path of a ray striking a microsphere. In order to maximise the use of space, the figure has been rotated to 90 degrees counterclockwise. The incoming light comes from the left through the objective. As mentioned above, the sum of all the forces caused by each individual\index{ray} ray is divided into two components: the gradient force which draws the object into the center of the beam due to the Gaussian intensity profile and the high numerical aperture of the objective. The second component \emph{i.e.} the scattering force, pushes the object along the direction of light propagation. 
\fig{ro}{Ray-optics model after Ashkin}

\maraja{The need for gradient force}
Without gradient force, the \index{scattering} scattering force will push the object out of the trap. Balancing the scattering force with a \index{gradient} gradient force component that is steep enough is therefore a \emph{condicio sine qua non} to trap particles. Given this, it can be seen the trap location will always be above the focal point of the objective in the absence of other external forces. 
...
N.A. = n\sin\alpha
\end{equation}
We also need to consider, for the most basic requirement, a\index{Gaussian} Gaussian distribution of the intensity profile linearly polarized. The polarization is important because it affects the Fresnel\index{Fresnel coefficients} coefficients values. We can observe a difference in trapping force if the beam has its polarization parallel or perpendicular to the displacement of the particle. 

As it is mainly the rays\index{ray} with maximum angle of convergence that contribute to the optical trap, we assume the objective lens is completely filled by the incoming beam. However, if the beam is too large and overlap the back aperture of the objective lens, it can induce optical aberrations affecting the quality of the trap. In this case, an Airy disk around each trap may be observed.

The numerical aperture\index{numerical aperture} of the objective used for optical trapping is also a very important parameter. As mentioned, if the edge of the beam is not focused at an angle that is steep enough, it results in a dominant scattering force that pushes the particle out of the focal point. The strong field gradient is along the direction of propagation produced by the peripherals rays in the focused beam and not by those rays along the optic axis. For this reason, it can be seen that most optical tweezers setups use a high {N.A.} objective \emph{i.e.} $>0.8$. However, increasing the {N.A.} also reduces the trapping depth and increases the power losses. 

Figure \ref{rays} shows the different configurations for a trapped micro-sphere. The illumination comes from the bottom. In the case of (a), the numerical aperture is not high enough, and the scattering momentum\index{momentum} shown by the two blue arrows pointing downwards produce a force pushing the particle up. In the case of (b), the numerical aperture is high enough; the sphere is snatched by the beam. (c) and (d) show the spheres at equilibrium. As mentioned before, it is worthy to note here that this point is located slightly above the trap. This means for an ICS microscope, a trap located on the image plane will not be able to hold a particle in focus. 

\fig{rays}{Different trapping configurations}

Figure \ref{axial} taken from Ashkin's\index{Ashkin} work shows the qualitative efficiency ($Q$ factor), for different axial positions and for a \SI{10}{\um} sphere. We note that the vertical trap tolerance is less than \SI{3}{\um}. With higher values, the specimen will be ejected away from the trap.\index{efficiency}

\figc{axial}{Axial efficiency}{Qualitative axial efficiency for a 10 micron sphere in water}

We are able to observe from figure \ref{transverse} a qualitative relation between the transverse force\index{transverse force} with regards to the power of the trap. Note these values are dependent on the beam polarization \cite{WRIGHT1993}. The transverse force is bigger for a motion parallel to the beam polarization.\index{polarization}
...
Finally, if we compare an effective transverse force of \SI{100}{\pico\newton} with regards to the mass of \SI{10}{\pico\newton} of a \SI{10}{\um} silica sphere, a trapping power of \SI{50}{\milli\watt} is more than enough. However, the trapping power should not be confused with the laser power output. The trapping power is the effective power that contributes to a specific trap.
...
\maraja{Torque}For the basic cases, a trap beam has a Gaussian intensity distribution and does not carry any angular momentum. However, by using a higher mode of a laser beam, it is possible to transfer not only forces but also torque to the trapped object. Allen \emph{et al.} showed that a \index{Laguerre-Gaussian}Laguerre-Gaussian amplitude distribution processes an angular momentum \cite{ALLEN1992}. Figure \ref{oam} shows the Poynting vector of a linearly polarized Laguerre-Gaussian beam. This vector represents the directional energy flux density of an electromagnetic field. 
...
Moreover, it is possible to create an optical angular momentum with a combination of cylindrical lenses. A more versatile solution consists of using a diffractive optical element (\gls{doe}) such as a fork grating shown on figure \ref{fork}. This figure shows the superposition of a blazing function which can move a trap laterally with a circular phase shift. We note this DOE is a purely transparent phase object. 
...
If angular momentum can be used to induce a continuous spinning of trapped samples, no position control can be achieved unless a feedback loop with real-time image processing is used. Another approach is to reduce the symmetry of the trapping beam. Such a rotation has been realised by the use of high order cavity modes by generating a higher order of the Hermite-Gaussian beam. Alternatively, it can also be achieved with \index{cylindrical lens}cylindrical lenses \cite{DASGUPTA2003} or \index{aperture}rectangular apertures \cite{ONEIL2001}. 

\fig{am}{Different methods to apply a torque on particles}

Figure \ref{am} illustrates different solutions to give a torque to a trapped object. A circularly polarized beam (a) features a spin angular momentum which can rotate \index{birefringent} birefringent objects. Using an orbital angular momentum (\gls{oam}), herein $LG_{10}$ (b), particles can be trapped on the doughnut shape of the beam and forced to circulate in the direction of the angular momentum. Asymmetric objects such as bacteria \emph{e.g.} E-coli\index{E-coli}, can be held by using two beams or a shaped beam (c). Eventually, an irregular object can scatter light into an OAM-containing mode (d).

Alexander Jesacher\index{Jesacher} et \emph{al.} demonstrated a \index{pump}micro-pump using optical vortices \cite{JESACHER2006}. Figure \ref{pump} shows a micro-pump which allows for controlled transport of released particles. 

\fig{pump}{Micro-pump demonstrated by Jesacher and co-workers}

Theodor Asavei and his co-workers made a micro-paddle\index{paddle}\index{two-photon} with the two-photon photopolymerization technique. By trapping the two edges with two laser traps, the structure which is held by the two traps can levitate. Then, a third trap exerts a radiative pressure on the paddle and creates torque\index{torque}. Figure \ref{paddle} shows the rotation\index{rotation} of this micro-structure \cite{ASAVEI2009}.
...
Figure \ref{setup-simple} shows a simple apparatus for optical trapping. A laser source produces a laser beam enlarged by the beam expander formed by L1 and L2 in order to fit the back aperture of the objective. A half wave plate\index{half wave plate} (HWP) followed by a linear polarizer plate (LP) allows for the adjustment of beam power by rotating the HWP. A dichroic filter (DF) reflects the laser beam to the objective and allows the illumination to go through it. A white light source is focused on the back aperture of the objective with a convergent lens (L) and a condenser (C). This forms a Köhler\index{Köhler} illumination and avoids imaging the light source on the camera plane. The objective and its tube lens form an infinite corrected system (\gls{ics}) which ensures telecentricity of the imaging part. An electronic \index{camera}camera is positioned at the focal distance of the tube lens. An additional filter (F) can notch the spectrum to eliminate the residual laser component.

\subsection{Force measurement}
When a bead is moved from the trap center due to an external force, the outcoming laser beam is deflected. This deflection can be directly measured using a four quadrant position detector (\gls{qpd}). 
...
The initial plan for this project was to use two objectives as shown on figure \ref{ip2}: an imaging objective on the vertical direction and a tweezers objective on the side. This side objective aims to directly trap and rotate an organic specimen.
\fig{ip2}{Initial proposition with two objectives}

\maraja{Cylindrical lens for rotation} Cylindrical lens \index{cylindrical lens} would have been used for beam asymmetry, therefore inducing torque to the trapped particle. However, this idea was abandoned because of several issues. Firstly, the observation volume needs two observation windows with optical quality. Making such glass container is a challenge in itself. Secondly, the working distance for the tweezers apparatus is very short and could bring the two objectives into contact with each other's. In this case, choosing objectives with less magnification and longer working distance will lead to a lower numerical aperture. Thirdly, as even the imaging volume can be seen as small, it would be an ocean for a micrometer-size cell. Finding cells and trapping them requires the moving of the stage while keeping both objectives in focus.
...
\maraja{No side trapping} Faced with these facts, we decided early on in this project to find a more versatile solution with which optical alignment and sample preparation are not such critical factors. That is how we came up with the idea of holographic optical tweezers and microfabrication. 

\chapter{Holographic Optical Tweezers}
\section{Introduction}
The basic setup shown in figure \ref{setup-simple} suffers from a major drawback. The trapping beam is centered at the middle of the imaging plane and cannot be moved. Of course, this elementary setup can be improved by adding a galvano mirror that will give it an additional degree of freedom. Placed right before the beam expander \index{telescope}telescope, the galvano mirror can be driven not only for moving the trap on the sample plane but also to create multiple traps with a fast scanning algorithm. However, this solution works only for a few traps, the scanning speed rapidly becomes a limitation of performance as the number of traps increase. 

\fig{hotsetup}{Holographic optical tweezers setup}

Figure \ref{hotsetup} shows a schematic representation of a standard holographic optical tweezers (\gls{hot}) setup. Instead of using a \index{galvano mirror}galvano mirror, a reflective diffractive optical element (\gls{doe}) is inserted at the Fourier plane of the light path in order to obtain an image of its gratings at the back focal plane of the objective. 

A DOE is a purely transparent phase object usually fabricated by micro lithographic technology\index{lithography}. Its micro relief will alter the wavefront of the input illumination which is supposed to be a planar wave. 

The size of the illuminating \index{Gaussian beam}Gaussian beam is a compromise between power efficiency and resolution. On the one hand, the larger the beam, the better use it makes of the area of the DOE in which it leads to a higher resolution of the produced image. On the other hand, if the illuminating beam is too large, a fraction of the incident power is lost outside of the active area of the \gls{doe}. This light, will go in the zeroth order \emph{i.e.} a bright spot on the middle of the image. 

\fig{doe}{Diffractive optical element in a 2-f system}

Figure \ref{doe} illustrates the effect of a DOE in an 2-f system. The top images row shows the intensity of the complex electric field at different positions along the light path while the bottom row shows the phase of the electric field. The \index{DOE}diffractive optical element is positioned at the focal distance of a convex lens. A screen is placed at the same distance after the lens. A fundamental \gls{tem}$_{00}$ Gaussian illumination strikes the DOE from the left. Along the propagation, the wavefront of the beam is distorted. The lens acts as a quadratic phase object which will focus the beam on the screen. We can observe on the screen the achieved image herein, a cross, a square and a circle. At the positions (b) and (d), the images represent the DOE and the lens in terms of their phase and amplitude components. 
...
\maraja{Dynamic DOE}Using this example, we can envision creating a specific DOE to create an array of traps that can be used to entrap different specimens. Nevertheless, the traps locations are still static. The objective for holographic optical tweezers is to use a dynamic diffractive optical element. Such devices are known as Spatial Light Modulator (\gls{slm}). They can work either in transmission or in reflection. Some of them can modulate the amplitude of the incoming light, and others can modulate the phase. As we have seen, using amplitude SLM would be a poor choice because most of the light may be absorbed by the device. This will lead to a very low efficiency of the trapping system.

From now, let us call the phase object \index{SLM}(SLM or DOE) a phase hologram. Generating this hologram is not a straight forward process because only half of the information can be encoded at a time. The 2-f\index{2-f} system illustrated above performs a Fourier transform between the hologram and the object plane. If we want to generate two arbitrary positioned traps and we compute the inverse \index{Fourier}Fourier transform of the desired amplitude, we will get two components. But the hologram cannot modulate the amplitude of the light. In the first approximation, we can simply ignore the amplitude part. However, a question may arise: is it possible to get a better hologram if we assume the phase component at the object plane to be non-uniform and the amplitude of the hologram to have a Gaussian profile? Iterative algorithms are usually used to improve the hologram efficiency. 
...
Under the paraxial approximation, we can study the 2-f system illustrated previously. As showed on figure \ref{2f}, the objective here is to analyze the equation of a phase hologram that generates a single trap located at a specified position from the image plane, located on the right side of the figure.  
...
First, let's describe the trap as a diffraction limited spot projected to the object plane at the location $(x_m, y_m)$. Its amplitude can be expressed as: 
\begin{equation}
{U_0}(x,y) = \delta (x - {x_m},y - {y_m})
\label{trapeqn}
\end{equation}
As the Fourier transform of a Dirac is a linear phase, our hologram in this case will be in this case a pure phase object which makes possible back propagation under Fresnel approximation. 
...
To be described later, when several traps are taken in account, the hologram becomes a fully complex object with an amplitude and a phase information. Optimizations algorithms can enhance the reconstruction quality for a missing amplitude component.
...
From the Rayleigh-Sommerfield diffraction theory and under the Fresnel approximation, the complex field after a travel in free-space $d$ can be expressed either with a convolution or an integral form \cite{GOODMAN}: 
\begin{equation}
...
\label{fresneleqn}
\end{equation}
where $\lambda$ is the wavelength of the light. As the first term is a constant phase shift, it may be neglected for a non-interferometric application. 
\subsection{Back-propagation on the SLM}
The trap on figure \ref{2f} expressed with the equation \ref{trapeqn} can be back propagated to the Fourier lens using (\ref{fresneleqn}), the distance of propagation becomes $d=f-z_m$.
\begin{equation}
...
\label{deltaeqn}
\end{equation}
The first part (a) is a blazing function that corresponds to the lateral shift of the trap. The Fresnel lens (b) has the same form as (\ref{lenseqn}) which is a quadratic phase\index{quadratic phase} shifting the trap along the z-axis. A third part can also be added to this expression to induce an angular \index{angular momentum}momentum.
...
Figure \ref{symtraps} shows the two polar components of the hologram for three different algorithms. With a simple superposition of the two traps, all the information is held by the amplitude component. However, with the two other \index{algorithm}algorithms, we can minimize the intensity information and maximize the phase component. 
\clearpage
\section{Hologram Generation}
As the hologram does not have any control on the amplitude, the best reconstruction cannot be made without compromise between efficiency, generation time, uniformity or ghost traps. Researchers have created hologram generation algorithms to maximize one specific point. Roberto Di Leonardo did an interesting work by comparing existing algorithms together as well as his new iterative algorithm \cite{DILEONARDO2007}. 

He started with the expression of total \index{complex amplitude}complex amplitude of the electric field at the position of a trap considering that the total average time of the energy flux through the SLM is given by: 
\begin{equation}
W_0=\frac{c\epsilon_0N|u|^2d^2}{2}
\end{equation}
where $N$ is the total number of pixels and $d^2$ the size of each pixel \index{SLM}on the SLM. He assumed the hologram is illuminated with a uniform plane wave and expressed the complex amplitude for each $j$ pixel: 
\begin{equation}
u_j=|u|e^{i\phi_j}
\end{equation}
...
I_m=|v_m|^2
\end{equation}
From this expression, Di-Leonardo\index{Di-Leonardo} established three different strategies quantified by three parameters; efficiency $e$, uniformity $u$, and the standard percent deviation $\sigma$:
\begin{equation}
...
\end{equation}
A benchmark test has been performed on 10x10 traps arrays which offer a highly\index{symmetry} symmetric configuration (see table \ref{algoperf}). For numeric values, please refer to the original publication. Here, we are interested in qualitative results only. The quality is expressed with a range of one to four stars. 
...
From these results, we can first observe that the first compromise is speed against performance. The Direct Search Algorithm (\gls{ds}) is a kind of brute force algorithm. Its performance is remarkable but it is realistically too slow to be used in a real-time application. Only three of these algorithms are of special interest. The Random Mask (\gls{rm}) is high in speed but its efficiency decreases rapidly when used with more than three traps. The \index{random superposition}Random Superposition (\gls{sr}) is a very good compromise between speed and performance. It can be used from the range 3 to 10 traps with a relatively good efficiency. Finally the Weighted Gerchberg-Saxton offers very good performance but requires more computation time. 
...
The random mask encoding technique (\gls{rm}) is a direct and non-iterative algorithm efficient for a very small amount of optical traps. As it is fast, it can be used to quickly generate some additional traps over an existing configuration \cite{USATEGUI2006}. 
...
\end{equation}
A slightly modified form of this algorithm can lead to a better compromise. By adding a random phase $\theta_m$ pre-defined for each trap, the uniformities of the traps can be significantly improved as seen on \ref{algoperf}. The new expression is given by:
\begin{equation}
\phi_{SR}(x_j,y_j)=\arg\left[ \sum_{m=1}^M e^{i(\Delta_m(x_j,y_j)+\theta_m)}\right]
\end{equation}
This second form is called Random Superposition (\gls{sr}). Just like the random mask algorithm, these two forms of the superposition method can be easily implemented using OpenGL, DirectX or a specific computing platform such as \gls{cuda} on a graphics processing unit. A GSL and Matlab implementation can be found on the annexe \ref{srsource}
\clearpage
\subsection{Gerchberg-Saxton}
The original Gerchberg-Saxton algorithm (\gls{gs}) was developed by the crystallographers Ralph Gerchberg and Owen Saxton to complete wave function from intensity recording in the image and diffraction planes. 

Figure \ref{gs} shows the original algorithm using the fast Fourier transform to go back and forth between the image and the hologram plane. A random phase is initially injected as a source hologram. The SLM/DOE\index{SLM}\index{DOE} illumination can also be considered as the intensity distribution of the hologram. The specified target is injected back with the phase issue from the first transformation. This algorithm usually converges quickly after a few iterations. 
...
\begin{equation}
U_k^H=\sqrt{I_H}\exp\left(i\varphi_{k-1}^H\right)\hfil\varphi_k^T = \arg\left(FFT\left(U_k^H\right)\right)
\end{equation}
\begin{equation}
U_k^T=\sqrt{I_T}\exp\left(i\varphi_k^T\right)\hfil\varphi_k^H = \arg{FFT^{-1}\left(U_k^T\right)}
\end{equation}
where $H$ stands for hologram side and $T$ target side. The parameter $k$ is the iteration number. 
...
Conceived in 2010, \index{Di-Leonardo}Di-Leonardo claims this algorithm gives better uniformity and better quality of the traps\index{Weighted Gerchberg-Saxton} than the original Gerchberg-Saxton algorithm. Furthermore, it is a generalized three dimensional algorithm using the Fresnel propagation to create off-plane traps. 

\fig{gsw2}{Flowchart of the Weighted Gerchberg-Saxton algorithm}

This algorithm has been successfully implemented using CUDA\index{CUDA} on a NVidia GPU for 768x768 pixels hologram with a frame rate of \SI{20}{\hertz} \cite{BIANCHI2010}. 
...
Liquids Crystals are commonly used to make electro-optic devices. They can be described as dielectric birefringence microscopic crystals with a cigar shape. When a steady or low frequency electric field is applied on liquid crystals (\gls{lc}), the electric force exerts torque on the molecules and they rotate towards the direction of the electric field. 

Nematic is a phase topology where the LC molecules are randomly distributed as in a liquid but still maintain their long-range directional order. When placed between two parallel glass plates linearly rubbed, the \gls{lc} will align themselves with the direction of the glass surface grooves. Figure \ref{nematic} shows two possible different phases of LC and the direction of the two index of refractions, ordinary $n_o$ and extraordinary $n_e$. 
...
Due to the birefringence, the position of the molecule will change the overall index of refraction of the \gls{lc}. This results in a combination of the ordinary $n_o$ and extraordinary $n_e$ index of refraction, expressed as: 
\begin{equation}
...
In addition, a \gls{lcos} display cannot be driven with a \gls{dc} voltage because it will cause a permanent rotation of the liquid crystal molecules. Most of the SLM does not control each pixel with an analog voltage due to the driving complexity. Typically, two references voltages can be chosen $V_{bright}$ and $V_{dark}$ which are the two binary values that can be applied on each pixel. An addressing sequence modulates each pixel to obtain different phase levels. Because of bandwidth considerations, the refresh time is limited and a compromise has to be made between the number of phase levels and the refreshing rate.

\subsection{Digitalization}
Hologram generation with \gls{lcos} microdisplays are digitalized in two ways. Firstly, there is a spatial digitalization due to the discrete pixel structure and secondly, the phase digitalization. The number of phase level is a compromise with the refreshing rate. However, we have observed that the number of phase levels is not critical. Figure \ref{levels} shows the reconstruction of Lena with a quantitated phase. 
...
Holoeye markets a phase light modulator in two versions. One for near-infrared optimized for \SI{800}{\nano\metre} and the other for the visible range. Figure \ref{pluto} shows the SLM unit. SMART has purchased these two Pluto SLMs. One for the near-infrared referred as Pluto-NIR, and the other for visible light (Pluto-VIS). The main difference of these two devices is the reflection enhancer coating on the top of the reflective aluminium layer. 

\fig{pluto}{Overview of an PLUTO Phase SLM from Holoeye AG}

The main unit provides a \gls{dvi} interface which is seen as a secondary monitor. A serial interface allows for configuration of the main driving voltages and the lookup-table. Table \ref{plutospec} shows the main specifications of this device.
...
Each sequence leads to different Lookup Table (\gls{lut}) values which correspond to the number of gray levels available. Since the addressing depth is only 8-bits, a maximum of 256 phase levels can be obtained even though the LUT length is 1024.  
...
\subsection{Summary}
As we have seen, a SLM\index{SLM} is a powerful device which suffers from poor efficiency. The pixels structure diffuses an important part of the incoming power into a high order of diffraction and the limited fill factor affects the total reflectivity. \index{OASLM}Optical addressed SLMs are more complicated devices but offer better performances in the sense that no pixel structure exists and all the light is concentrated on the main order. 

If efficiency is an important parameter, the response time is equally important for real-time applications that need control feedback loop. In this case a ferroelectric SLM would be preferred even though it can offer only two phase values. 

For our application, speed and efficiency\index{efficiency} are not critical. The \index{Holoeye}\index{Pluto}Holoeye Pluto-VIS is a suitable device and easy to use. Nevertheless, for a potential commercial application, other solutions should be explored. 

\chapter{VHIS}
\section{Background}
Volume Holographic Imaging System was originally developed in early 2000 by Prof. George Barbastathis \cite{BARBA2002}. This imaging system exploits the Bragg selectivity by using a hologram where the thickness is much larger than the light wavelength. This is in contrast with confocal \index{confocal microscopy}microscopy or optical coherent tomography \index{tomography}which can also image subsurface tissue structure with minimally-invasive properties. A \gls{vhis} can see multi depth planes at the same time without scanning. The hologram can be seen as a depth-selective element. During the \index{recording} recording procedure of this element which consists of superimposing several gratings in the recording material, it is possible to choose how many planes can be imaged and at which depth they are located. 

SMART has continued to work on this system to enhance its efficiency and are searching for new applications it can be used in, in the biomedical domain. 
...
The main element of a VH \index{VH}system is its \index{thick hologram}thick hologram. It is not placed straight in the optical path but at a certain angle. In this configuration the gratings recorded will deflect the light to an angle proportional to the wavelength of the incoming light. By combining multiple gratings\index{grating}, it is possible to create multiple deflection angles corresponding to an imaging plane located at a certain depth in the sample. For a certain wavelength, a ray is deflected at only one certain angle. In this case, the ray is Bragg-matched\index{Bragg} with its wavelength. 

Thus, the lateral field of view is proportional to the bandwidth of the illumination. Figure \ref{vhlambda} illustrates a basic \gls{vh} system composed of an imaging lens and a Fourier lens. Located at the Fourier\index{Fourier} plane of the screen, the thick hologram is placed at a certain angle. The two squares represent the matching location for both the imaging plane on the left and the observation plane on the right in terms of wavelength. In this example, the sample is illuminated with an uniform broad band white light source (400-\SI{700}{\nm}). Therefore, on the observation plane, we can observe a rainbow pattern. Each wavelength component comes from a Bragg-matched x-position on the image plane. The wavelength selectivity is even better when the hologram is thick.

\figc{vhlambda}{VHIS, basic setup}{VHIS, basic setup illustration of field of view related to the illumination bandwidth}

We can also notice on this figure that the imaging plane is matched to a $x'_0$ position on the observation plane. During the hologram recording, it is possible to add multiple gratings to match another depth on the imaging side to another $x'_0$ location on the observation plane. The figure \ref{vhlambda2} shows two planes (A and B) and their corresponding representation on the observation plane. Here the hologram has two gratings matching different depths. The field of view $\Delta L$ is still directly proportional to the illumination bandwidth\index{illumination} $\Delta\lambda$. The line color on this figure has nothing to do with the wavelength. 
\fig{vhlambda2}{VHIS, illustration of two plane imaging}

\section{Bragg diffraction}
It is worth talking a little bit more about Bragg condition for a better understanding of the VH. Figure \ref{bragg} shows a thick hologram with a cosine grating. In fact, this grating is a refractive index grating and not an amplitude grating. When an incoming beam with a $k$ vector $\vec k_i$ strikes the hologram, a part of it will be transmitted without alteration. Another negligible part not shown here will be reflected. Lastly, one part $k_d$ may be diffracted at the same angle from the incident beam $k_i$ when the incoming rays angle and their wavelength matches the Bragg condition. 
...
Figure \ref{bragg2} applies this principle in a \gls{vh} configuration. An object is located at the focal point of the imaging lens. The light scattered by one point is a spherical wave which is converted to a planar wavefront by the lens. This wavefront possess a certain angle. Because of the thick hologram, only a Bragg-matched angle will be diffracted. The Bragg diagram located on the bottom right shows the hologram k-number in black. The $k$ vectors shown in red and green. The diffracted rays lead again to parallel rays that are focused by the Fourier lens to one location on the observation plane. 

\section{Original optical setup}
The original VH setup installed at \gls{smart} BioSyM is shown on figure \ref{vhsetup}. A selective broadband light source is collimated to the image plane. In order to obtain the Fourier transform of the image at the hologram position, a relay images the back aperture of the objective which is also the Fourier plane at the hologram position. As the Bragg diffraction operates at a certain angle, the observation plane is not aligned with the rest of the setup. A third relay images the hologram at the back aperture of the observation objective. A camera is then placed at the focal point of this objective. 

\fig{vhsetup}{Volume hologram setup currently in use at SMART}

The important point to note in this setup is that all components are conjugated. The image plane is directly conjugated with the observation plane in terms of distances. Therefore, the optical alignment is a critical part. 

We can also note the thick hologram is not exactly oriented at 45$^\circ$ in this figure. This is because the hologram is not a simple vertical thick grating but a slanted grating. In practice, the hologram is first oriented to an angle of about 45$^\circ$, then its orientation is finely adjusted. 

\section{Scale consideration}
On figure \ref{debris}, we can observe a dead cell focused on each plane. The planes are virtually separated with white lines for better understanding. The plane separation is about \SI{50}{\um} and we can observe that the specimen is out of focus on the adjacent planes. That said, it can also be noticed the specimen is shifted to the left on each plane. Therefore the translation stage needs to be moved if the specimen needs to be seen in its entirety. 

However, the purpose of the VH is to image a specimen at different depths without the need to adjust its position. In this case, only objects smaller than the field of view can be observed with this volume holographic imaging system. 

\figc{debris}{Dead cell}{Dead cell imaged on the existing five planes with VH installed at BioSyM}

\section{Illumination spectrum}
As seen before, the bandwidth of the illumination is proportional to the field of view. A halogen white light source is for instance far away and too broad. The holograms used in this project are designed for an illumination range of about \SI{30}{\nm}. Therefore, a band-pass filter is required if the illumination is broader. Figure \ref{vhiscolor} shows 4 images aquired with different filters of the 1951 USAF resolution target. We observe a shift of the two planes on the left as the center wavelength is increased.

\fig{vhiscolor}{USAF 1951 observation through different band-pass filters}

As mentioned above, the field of view position depends also on the center wavelength. Figure \ref{vhistarget} shows the position of the field of view for the different filters used. The scale is given both in distance and wavelength. 
...
Two-photon absorption (\gls{tpa}) was predicted in 1931 by Maria Göppert-Meyer thirty years prior to the first experimental observation. Described as a nonlinear optical process, TPA is the simultaneous absorption of two photons by a molecule which is placed in a higher energy state. This absorption leads to photo dissociation \emph{i.e.} a break of a molecular bond. As this process is non-linear, its probability of happening becomes significant only at high laser power. 

\maraja{Curing the resin}
The photosensitive resin is highly transparent in the near-infrared range while it is absorptive in the \gls{uv} range. Therefore, UV light cannot penetrate the resin and will be absorbed at the surface. In this case, we will discuss about one-photon absorption. With infrared laser light, the beam will pass through the resin without absorption unless the density of power is high enough to initiate TPA. Figure \ref{2pa1pa} shows the single-photon absorption with UV light that occurs at the surface (a) and the two-photon absorption with near-infrared laser. The achievable resolution is better in the x-y plane because of the diffraction limited theory. Therefore, a volume pixel (voxel) which is an ellipsoid shape is the basic unit structure. 
...
\maraja{SU-8}
The most common photosensitive material is SU-8, a negative epoxy-type patented by IBM in 1989. After curing, the resin has to be developed typically with acetone or \emph{propylene glycol methyl} ether \emph{acetate}. Eventually, the result is a transparent object with a refractive index close to 1.5 which is perfectly suitable for optical trapping.

\section{Microstructures}
\maraja{Potential collaboration}Upon realizing that the option of manufacturing a custom micro tool was possible for this project, Alexander Legant from Nanoscribe AG was contacted. He gave us two contacts in Switzerland: Jakub Haberko from the physics department at Fribourg University and David Borer from \gls{eth} Zürich (ETHZ). We proposed collaboration on this project but they informed that working with the Nanoscribe system is not a straightforward operation and time is an essential component in getting the system to work as desired. 
...
\label{2ppactions}
\maraja{Obstacle}
Regrettably, we were unable to investigate further with this option for this project as the new \gls{2pp} setup installed at NUS requires more tests. However, \gls{smart} wants to pursue this idea. A basic microstructure is planned to be made when Bettiol's setup is ready. 
...
The samples used are polystyrene spheres (density of \SI{1050}{\kg\per\cm^3}) as previously bought by Lang's group at BioSyM. Different spheres sizes were chosen and their properties are shown in table \ref{tablespheres}. 
...
\end{tabular}
\caption{\label{tablespheres}Micro-spheres used in this experiment}
\end{center}
\end{table}

Initially, unsuitable optical parts were assembled and the overall mechanical stability was not adequate to trap anything. Thorlabs cage system combined with a rigid damped pole was chosen to build a new setup. 
...
Imaging an out of focus spot as on the image (b) can help to center the field of view of the camera and adjust the laser spot in the middle of the objective \gls{fov}. If not aligned, the point spread function become not symmetric. 
...
\end{equation}
We have measured at the edge of a line a transition of 5 pixels from 10\% to 90\% which corresponds to a physical resolution of about \SI{200}{\nm}. The laser spot has \gls{fwhm} diameter of 18 pixels which corresponds to \SI{0.8}{\um}. However, due to the \gls{ccd} technology used by the camera, the strong intensity of the laser spot may spread to the surrounding pixels and give a biased result. 

\figc{exptw2}{Trap on focus}{Trap on focus at the image plane, objective 100x NA 1.4 oil immersion}
...
On the first attempt, we dropped \SI{100}{\micro\liter} of a diluted solution containing \SI{10}{\um} beads on a microscope slice. The slice was then covered with a \SI{0.17}{\mm} glass cover. Unfortunately, we were unable to trap any spheres with this preparation because the space between the slit and the cover slit was too small and the spheres were entrapped in between. 

We were inspired by Lang's group's method which would be to use a double sided adhesive tape to create a microchannel. The procedure is illustrated in figure \ref{slice}. Firstly, the glass cover is recovered with double adhesive tape. During this operation, close attention must be paid to ensure air will be trapped. The microchannel will have a width of about \SI{2}{\mm}. The sharp edge of the slice of glass can be used to cut off the excess tape. Then a glass cover is placed on the channel (5). Better adhesion is ensured by pressing firmly on both sides. The slice is then flipped upside down and with a dispenser, the colloidal solution can be applied in the opening of the microchannel. Through capillarity, the liquid will fill the channel (6). In the event of air bubbles, a small vacuum pipette can be placed at the other opening while the channel is being filled with the solution. Once the channel is filled properly, it can be sealed with glue by applying on both edges with a small stick. With this method, the sample was able to last for a long time. 

\fig{slice}{Slice preparation}

The colloidal solution has to be diluted correctly. To proceed, concentrated spheres solution is added with water. \SI{200}{\micro\liter} is dropped on a cover slit and imaged by the microscope. The average amount of visible particles is counted and this value is written on the tiny vessel. Depending on the concentration level, the solution can be adjusted to become more diluted. 

\subsection{First time spheres imaged}
We had no success on our first attempt to trap some spheres. Figure \ref{firstspheres} shows in (a) air bubbles on our first sample which was mistaken for spheres. The second image (b) shows the overconcentration of \SI{10}{\um} spheres. 
...
Most of the spheres we tried to move seem to be stuck on the cover slit. Only a few of them moved even though we increased the laser power. It was also difficult to find free space to move the spheres as the concentration of the spheres was too high.

The experiment was successfully repeated with the \SI{1.5}{\um} spheres. However, the minimum trapping power was not measured. We also tried to trap the \SI{6}{\um} spheres but were not able to move them. All of them seem to be stuck on the slit. 

\subsection{Conclusion}
In this experiment, we succeeded in trapping a \SI{1.5}{\um} and a \SI{10}{\um} polystyrene sphere with a power of about \SI{3}{\milli\watt} on the sample plane. Moreover, with a power of \SI{30}{\milli\watt} we could damage some \SI{6}{\um} spheres and make the surrounding medium bubble. 
...
\subsection{Results}
Figure \ref{cyl} shows in (a) the cylindrical beam we obtained by a combination of two cylindrical lenses manually held together. During our experiment, we could damage the target's chromium coating as seen in (b). For this reason, it is important to add a neutral density filter before the objective lens. 

\fig{cyl}{Trapping beam with a cylindrical lens (a) and Target damages (b)}

\subsection{Issues}
After many adjustments we were able to see a line under the microscope but the quality was not ideal. With only one cylindrical lens the length of the line we obtained was larger than the field of view of the microscope as shown on figure \ref{cylissue2} (a). In our setup the second lens of the second telescope is too far away from the objective lens. Without considerable changes to our setup, no solutions were found to reduce the size of the line trap. 
...
\maraja{RedTweezers from Glasgow}RedTweezers, a software designed by the University of Glasgow runs its visual interface on LabVIEW and a background daemon generates the hologram using a graphic card computational power. The use of this software is detailed at section \ref{redtweezers}. RedTweezers was mainly used during this project because of its good trap quality and its intuitive interface. 

Our first attempt is shown on figure \ref{exp2align} where the alignment was checked using the USAF 1951 resolution target and with a neutral filter placed on the laser path. We were able to easily create, delete, move and rotate traps. 

\figc{exp2align}{Multi traps with HOT}{(a) One trap located at the zero-order position (b) MIT written with 29 traps}

Obtaining the first trapping results was pretty straightforward. RedTweezers was loaded on the \gls{pc} just as the camera interface. A diluted sample was prepared in the same way explained above and the laser power was increased up to \SI{1.5}{\watt}. Compared to our first trapping experiment, the overall efficiency of the HOT setup is pretty low. A significant part of the power was lost at the spatial filter in order to obtain a uniform and good beam quality. The iris placed just before the SLM also cut a part of the power so that only 60\% of the laser power hit the device. Next, if we consider the efficiency of the SLM itself, only 50\% of the incident power was reflected into the zero order. Then, there were still two lenses, the beam-splitter and the objective lens. The final efficiency was about $\eta=20\%$. Eventually, only \SI{300}{\milli\watt} got through the objective. This power was equally distributed in the 4 traps used which resulted in about \SI{80}{\milli\watt} per trap. 
...
Another laboratory from NUS was cultivating the growth of Escherichia coli bacteria. These bacteria have an elongated rod shape and are suitable for rotation with a shaped optical trap. We use here an line of traps to get and rotate. Figure \ref{ecoli} shows some frames of a video recorded. 

\fig{ecoli}{Rotation of an e-coli bacterium with HOT} 
\fig{mitrotate}{Rotation of MIT logo with \SI{0.75}{\um} spheres}

The e-coli chosen here was particularly long. Our previous attempt with the shortest ones were challenging because the bacterium aim to align itself with the axial direction of the trapping beam. Figure \ref{ecoli2} shows on (a) several e-coli trapped in the vertical position in our 5 traps. In (b), we can observe the same case with two beams. 

\fig{ecoli2}{E-coli trapped in the vertical position}

With this experiment we succeeded in the rotation of an organic object by the use of a shaped beam which is composed of an alignment of several traps. This leads to the same result which we can obtain with the use of a cylindrical lens. 

Before this experiment, we ensure we could trap and rotate as small objects. Figure \ref{mitrotate} shows a configuration of 25 traps displaying MIT that we rotated over 360$^\circ$ in about 20 seconds. The spheres chosen had a diameter of \SI{0.75}{\um} which is approximately the width of an e-coli. 
...
Holoeye provides a tool to calibrate their Pluto SLM. However, this tool is not very adapted and has several bugs. For instance, it is only compatible with a limited type of camera such as webcams. 
...
\figc{cal2}{Calibration output}{Calibration output. (a) last signal acquired, (b) last camera capture, (c) phase shift, (d) superposition of the acquired images}

We can observe on figure \ref{cal2} the script main interface refreshed at every new acquisition. The top left curve (a) shows the vertical projection of the center part of the raw image (b). The blue curve in (c) shows the phase measurements points and the green curve is a matched polynomial function. On the bottom right corner (d), we ca observe the superposition of all the acquired projection. 

\subsection{Calibration Procedure}
We initially reset the two voltages $V_{dark}$ and $V_{bright}$ with the help of the SLM configuration tool in order to obtain a maximum phase shift range. Then, a default linear \gls{lut} is loaded into the SLM. 
...
In this experiment, a hologram for 5 different trap configurations was generated using 4 different algorithms (Random Mask, Superposition, Random Superposition and Weighted Gerchberg-Saxton). The implementation of these algorithms were written with Matlab and are available in section \ref{algos}.
...
The spot identification script started with finding the brightest pixel and obtained its 9x9-1 neighbors. The exact position of the spot was obtained with a correlation with an ideal Gaussian spot. Then, the spot was erased from the image and the next brightest pixel was reached. This procedure was repeated until the value of the brightest pixel is below a threshold value herein 30\% of the first brightest pixel.
...
We note very close results in terms of performance between SR and GSW. With identical holograms generation rates between S and SR, the SR algorithm showed better results. Random Mask was far behind despite its generation speed. 

\subsection{Uniformity} 
The uniformity for each of the five targets is shown in table \ref{unif}. By comparing only \gls{sr} and \gls{gsw}, we observe no evidence of improvement with an iterative algorithm for the random target \emph{i.e.} number 2, as claimed by J. E. Curtis \cite{CURTIS2005}. The GSW algorithm is always slightly better than SR except for target 4 which is a very small array of condensed traps. Some measurement errors in the spots intensity could be the cause.

In terms of uniformity, the S algorithm showed slightly better results than SR except for target 4. Perhaps, this target should again be ignored.  

\begin{table}[h]
	\begin{center}
    \begin{tabularx}{\linewidth}{|X|c|c|c|c|c|} \hline
        Algorithm & 1    & 2    & 3    & 4    & 5    \tnl\hline
...
As we did not measure the incident laser power on the camera, the absolute efficiency cannot be measured. The results shown in table \ref{effi} were normalized to 100\%.  
\begin{table}[h]
	\begin{center}
    \begin{tabularx}{\linewidth}{|X|c|c|c|c|c|} \hline
        Algorithm & 1    & 2    & 3    & 4    & 5    \tnl\hline
...
\end{center}
\end{table}
If we ignore target 4 which showed marginal results, we are able to observe very similar results between SR and GSW except for target 3 because GSW does not converge for 2 traps. 

\subsection{Standard Deviation}
The standard deviation of the intensity of each traps are shown on table \ref{std}. If we remove target 4 which has shown weak results from the list, GSW is unanimously better. However, SR is not very far behind. If we compare those results with the difference of computation speed, SR is undoubtedly the  algorithm of most interest. 
\begin{table}[h]
	\begin{center}
    \begin{tabularx}{\linewidth}{|X|c|c|c|c|c|} \hline
        Algorithm & 1    & 2    & 3    & 4    & 5    \tnl\hline
...
\subsection{Comparison with Holoeye hologram generation}
Holoeye AG provides with its SLM, a tool for hologram generation. We also used a reference target which was provided to compare our other algorithms. Table \ref{holotarget} shows our results. The hologram generated with the Holoeye tool gave slightly better results than GSW. It could be interesting to find out the algorithm they are using. 

\begin{table}[h]
\begin{center}
    \begin{tabularx}{\linewidth}{|X|c|c|c|} \hline
        Algorithm & e  & u    & $\sigma$ \\ \hline\hline
        RM        & 3  & 0.29 & 34        \\ \hline
        S         & 36 & 0.84 & 12       \\ \hline
        SR        & 49 & 0.77 & 15       \\ \hline
...
Close similarities can be observed between S SR and GSW as we neglect target 4 which shows different results once again. 

\subsection{Conclusion}
These qualitative measurements deserve to be repeated for more consistent results, especially for target 4 which shows marginal results. Di-Leonardo realized his benchmark only with an array of traps similar to target 4. We wanted to test here those 4 algorithms with other configurations such as a random trap distribution \emph{i.e.} target 2. We are able to confirm that iterative algorithms do not give better results in the case of low symmetry configuration. However, we have also showed that the GSW algorithm is not much better than SR. This is especially if we consider that fact that it is 10x slower than that of the random superposition algorithm. 

If this experiment is to be repeated, we would suggest finding a way to automate the data acquisition procedure and obtain measurements for 3 types of targets: rings, array and random distribution. For each type, we would propose to vary different parameters such as the number of traps or spacing. 

To conclude, the most interesting algorithm with regards to efficiency, uniformity, standard deviation and speed performance is SR. It is by far the best compromise. In addition, it can be easily implemented using pixels shader with a graphic card with a high frame rate value (>\SI{50}{\hertz}). 
...
\subsection{Relays}
One main element of a VH setup is an optical relay formed by 4 doublet lenses. Previously designed and optimized at \gls{smart}, we followed the same instructions to build 1 right angle relay and another conventional one. The components were bought from Thorlabs and figure \ref{relay} shows the 2D assembly for the straight relay.
...
Figure \ref{vhalign} shows 4 images that can be seen on the camera. In (a) the two lines blur and they are too close to each other. The slantted hologram needs to be flipped upside-down. \index{hologra} On the second image (b), the hologram is positioned badly; the light does not completely hit its active part. The third image (b) shows a poor positioning of the second arm and a wrong angle of the hologram. Both need to be moved in order to get the two lines as straight as possible in the middle of the sensor (d). 

\subsection{Filter}
\index{filter} When used with a white light source, the plane separation can be achieved because it is determined by the bandwidth of the illumination. A band-pass\index{band-pass} filter of about \SI{30}{\nm} needs to be used with this hologram. Figure \ref{vhtarget} shows an image from the USAF 1951 \index{usaf} resolution target with and without any band-pass filter. On the image (a) we can observe the right plane is in focus and the left is not. Also, the band-pass filter used (a) is too narrow, the field of view is limited and can be extended until the no black zone is left in between the two planes. For the third image (c) we used a too-wide filter and the two planes overlapped.  

\fig{vhtarget}{Resolution target seen with (a,c) and without (b) band-pass filter}

\subsection{Conclusion}
The new VH has been successfully aligned and it is ready to be integrated with the HOT setup. However, we noticed a very poor efficiency of the hologram used. Less than 1\% of the incoming light hit the camera. Other holograms need to be tested in order to get a better efficiency. That said, it is also possible to use a more sensitive camera. \gls{smart} bought an Andor camera designed for fluorescence imaging. If the illumination is insufficient when mounted on the HOT part, this camera may be used. 

\section{Volume Hologram with HOT}
The aim of this experiment is to bring the volume hologram setup together with the holographic optical tweezers setup. Previously, we have succeeded in building a VH setup with a two-plane hologram and we demonstrated the functionality of our trapping system. This setup is intended to work with the micro fabricated tools which we ordered and will arrive. 

\maraja{Planes separation}To validate this setup, we need to be able to trap some spheres located on different planes and this has to be monitored with the VH system. In addition, we should be able to move a trapped sphere from one plane to another. To note again, the \index{hologram separation}separation between the two planes on the hologram is \SI{30}{\um} while we previously demonstrated a displacement of a trapped sphere over a distance of more than \SI{50}{\um}. 

As we are aware of the relatively low efficiency of the VHIS, we replaced the GE-1650 camera with an \index{Andor}Andor iXon 888 which offers a fill factor of 100\% and a remarkable sensitivity. 

\subsection{Setup}
Figure \ref{setup3} shows the combination of the previously assembled VH which has been tested  and the HOT tweezers part. We have performed some small changes on both setups in order to ensure the compatibility. Firstly, on the VH part, we changed the orientation of the swivel stage so that we can mount the Andor camera which is much bigger in size than the previous one. This adjustment is visible on figure \ref{hot-vh3d}. Secondly, we placed an additional beam-splitter on the tweezers part in order to provide illumination for the VH through the 100x objective. 

During this experiment, we were compelled to replace the Coherent Verdi V10 with a less powerful model, a Coherent Verdi V6 because another research team needed it. As the laser position is critical for the entire setup alignment, we needed to realign all the optical components after installing the new laser. 

Initially we wanted to use only one objective lens for both of the VHIS and the HOT setups. However this change requires a new hologram to be recorded with the new setup and a specific laser is required for this operation. Hence we designed the setup the way we did. 
\figc{setup3}{HOT + VH Setup}{Functional diagram of the holographic optical tweezers setup (on the bottom) combined with the volume holographic imaging system (on the top)}
\figc{hot-vh3d}{3D view of the final setup}{Three-dimensional view of the final setup assembled with Thorlabs' parts}

\subsection{Alignment}
The alignment of the tweezers was smooth-going. All the components were clamped onto the optical table and even though the new laser required some of the components to be readjusted, we managed to obtain good traps on the sample plane easily. However, the VH has to be adjusted either in the z, x or y direction. As the whole of the VH is attached to the vertical damped pole, the x/y alignment is limited to one degree of freedom. But, the thick hologram can also be slightlymoved to adjust the viewing position. With regards to the z-axis, we added a precise Z-Axis translation mount 30mm cage system\index{SM1Z} (SM1Z) at the tweezers objective, after which, we were able to adjust the position of the focal point precisely. We also added another translation stage to move the whole of the VH vertically.\index{alignment} 

\fig{targetaligned}{Alignment of the HOT+VH with a resolution target}

After spending a significant amount of time on adjusting, we eventually succeeded in imaging the 1951 USAF resolution target on both of the VH \index{VH}\index{HOT}and the HOT setups. Figure \ref{targetaligned} shows the image obtained on both sides. The target colors are reversed on the HOT side due to the transmission illumination. With concerns to the second image, no band-pass filter was used to maximize the light intensity. The black circle is caused by the N.A. mismatch between the 50x objective and 100x. 

Once we aligned the setup, we tried to image the \SI{10}{\um} spheres but we could not see anything other than white light. By comparing the size of the 7th group of the resolution target, we realized the spheres would be too small to obtain any images. The second objective lens from the VH was a Mitutoyo 10x that we replaced with a Mitutoyo 2x to increase the overall magnification. 

Despite this modification, we were still unable to see anything. We then decided to trap and move a sphere to test for any variations on the VH. Figure \ref{firstspheresvh} shows in two images from the VH in (a) and (b) with the sphere at a different position. The central image is the pixel difference between (a) and (b). It is possible to guess the shape of the sphere here. 

\fig{firstspheresvh}{Sphere at two different positions as seen with the VH}

Although the system was aligned, we had an important illumination issue that we tried to solve first by modifying the illumination part and then by using fluorescent spheres.

\subsection{Illumination issues}
The main problem was a N.A. mismatch between the two objectives used. Usually in microscopy, both the condenser\index{condenser} and the objective lens have the same numerical aperture. In our case, the illumination comes from the 100x N.A. 1.4 and the sample is observed through a 50x N.A. 0.55. Figure \ref{illum} illustrates in (a) this problem. The illumination rays are shown in blue. Moreover, we can see that the cone of light that hit the top objective is very small and most of the illumination is lost. This is one reason why we needed the Andor camera. 
\fig{illum}{Illumination issue caused by N.A. mismatch}

A proper illumination also has to be focused at the back focal plane as shown on the second image (b). We modified our setup slightly to achieve this. Nevertheless, the illumination spot is in this case a collimated beam with a diameter limited by the objective front lens which will reduce the field of view on the VH. In addition, we can note that almost 75\% of the illumination is lost at the two beam-splitters. 

In a further step, it is worth replacing the top beam-splitter with a dichroic glass that will reflect the trapping laser \SI{532}{\nm} and transmit the illumination which may come from a LED\index{LED} source. The second beam-splitter can also be replaced with a dichroic filter that will reflect the LED bandwidth and transmit another band from a second illumination. As the spheres are almost transparent, a reflecting illumination will produce bad results. In this experiment, we used a second white light source to shine the sample from the top to see the sphere with the GE-1650 camera. 

After modifying the tweezers illumination portion, we realigned the system and acquired new images. Figure \ref{vhtw1} shows group 7th with a better magnification but with a smaller field of view. Unfortunately we did not succeed to obtain a collimated beam after the objective lens. Worse, the light source is almost focused on the imaging plane. The two images (a) and (b) illustrate the focus on the target in both planes which have a separation of \SI{30}{\um}.

\fig{vhtw1}{Target imaged on the tweezers side}

In spite of these adjustments, we were still unable to see the spheres properly. We therefore decided to switch to fluorescence spheres. 

\subsection{Fluorescence}
We obtained \SI{15}{\um} fluorescent\index{fluorescent} spheres with an absorption peak at \SI{540}{\nm}. Their emission is located around \SI{560}{\nm}. We used the \SI{532}{\nm} trapping laser to pump the spheres and we added a notch filter that blocks the excitation wavelength before the Andor camera. Figure \ref{expbeads} shows on the left the spheres as seen through the HOT objective lens in reflexion mode and on the right with fluorescence. This time with concerns tothe VH, we could observe the spheres as it is shown on figure \ref{fluo}. 

\figc{expbeads}{Spheres observed with fluorescence}{Spheres observed from the tweezers side in reflexion mode (a) and with fluorescence (b)}

A major drawback with these fluorospheres is their absorption at the trapping wavelength. Photobleaching occurred rapidly and the lifetime of a trapped sphere is less than one minute. Moreover, fluorospheres are more difficult to trap. We obtained the best compromise between photobleaching and trapping efficiency by setting the laser to \SI{230}{\milli\watt} which corresponds to approximatively \SI{2}{\milli\watt} per trap. 

\fig{fluo}{Fluorescent spheres as seen from the VH}

\subsection{Setup Efficiency}
In the meanwhile, we measured the total trapping \index{efficiency}efficiency with the knowledge that important optimizations can be made for instance, by removing the first beamsplitter needed by another research group. The beam intensity was measured at different positions and the results are given in table \ref{efficiencytable}. 
...
\end{tabularx}
\caption{Laser power drop of the final tweezers setup\label{efficiencytable}}
\end{center}
\end{table}

We noticed that only 8\% of the total power struck the imaging plane. This efficiency can be increased to 16\% without the first beamsplitter and by using dichroic mirrors we can expect to gain a few more percent. The last column shown on the table states the efficiency of the intermediate components. For instance, we can observe that the SLM has an efficiency of 45\% and the components located after the spatial filter \emph{i.e.} the mirrors, lenses and iris were dispersed and blocked 35\% of the incoming power. 

\clearpage
\subsection{Results}
As we were still faced with illumination issues, we used fluorospheres for the rest of this experiment. Although these spheres were more difficult to trap due to their fluorescence coating\index{coating}, we managed to trap and move several spheres. Our first result is shown on figure \ref{final1} where we moved a sphere from one plane to another. On the first image, a sphere can be observed to be in focus on plane A and blurry on the other. On the last image of this video sequence, the sphere is in focus on the second plane, \SI{30}{\um} above the principal focal plane.\par 
\fig{final1}{Moving a fluorosphere between the two planes of the VH}
The screen captures from the second video illustrated in figure \ref{final2} shows two spheres that have been moved back and forth between the two planes and rotated. Note the glowing intensity of the spheres decreased by a factor of 2 from the beginning to the end of this video capture due to the photobleaching effect. The yellow circles indicate the position of the spheres that are in focus.
\fig{final2}{Moving two fluorospheres between the two planes of the VH}
\clearpage
\subsection{Conclusion}
Although we have demonstrated the trapping capabilities of micro spheres and the rotation of them along an arbitrary axis observed through the VHIS, three main drawbacks still remain. 

First of all, no adequate illumination can be obtained with a condenser with a numerical aperture smaller than the imaging objective lens. In regular microscopes, the condenser is actually considerably big to collect as much light as possible from the source. In our case, the back aperture of the 100x objective has a diameter of \SI{6}{\mm} which is very small. We also tried to illuminate the sample through the VH objective by replacing the right angle mirror with a beam-splitter. However, transparent objects such as biological cells and spheres do not scatter a lot of light and nothing can be seen on the VH camera. 

Secondly, we used a two-plane slanted\index{slanted} hologram in this experiment. It turned out that this hologram has a very small efficiency (< 1\%). Because of this, only an extremely sensitive camera can be used to obtain some images. Even with a quantum efficiency of 90\% and above, a fill factor of 100\% and a dark current\index{dark current} below 0.001 electrons per pixel per second, we needed an exposure time of 0.9 seconds and an electron-multiplying gain of 300 to see the fluorosphere. 

Lastly, it can be seen from our results that the VHIS produces relatively poor image quality. Group 7 of the resolution target cannot be imaged optimally as compared to the images obtained from the tweezers part. 

However, the thick hologram has not been recorded on this setup which may lead to strong optical aberrations and poor efficiency. One can imagine to record a new thick hologram with more planes that offer a broader field of view in an alternative experiment. 

The illumination also needs to be reconsidered. A good option would be to use only one objective lens for both the VH and the HOT systems. In this case, it would be a proper Köhler\index{Köhler} illumination designed to match the imaging objective lens. Nevertheless, the objective requirements for both systems are in conflict. On one hand, the tweezers part needs a high numerical aperture\index{numerical aperture} and a small depth of field while on the other hand, the volume holographic imaging system requires a long depth of field if the system is intended for a projection tomography\index{tomography}. However, compromises may be achieved by slightly reducing the magnification factor and the N.A.

With regards to the tweezers part, we measured an overall trapping efficiency of 8\% because the laser output is split into half for two projects and also because we did not pay much attention to the shaping of the beam \emph{i.e.} obtaining a high quality Gaussian beam that would properly fit the SLM. 

To conclude, we succeeded in combining a volume holographic imaging system (VHIS) and a holographic optical tweezers (HOT) for trapping and viewing particles at different depths simultaneously. 

\chapter{Softwares, optical tweezers interface}
Generating a hologram with Matlab\index{Matlab} or another software\index{software} is one thing, but for real-time trapping, the traps pattern must be calculated continuously. Moreover, an intuitive user interface that allows creating, deleting, moving, grouping and rotating traps is fundamentally essential. 

Developing such control software is not a big challenge. However, optimizing it for good performance can be a challenge. For this project, we initially did not want to spend time on a tweezers visual interface application but due to limitation encountered with the available tools and the available time we had when we were waiting for the new Thorlabs parts, we devoted a fraction of this project to study for a more optimum solution. 

\section{Existing projects}
At the very least, there is one useful free tool available for optical trapping. It is called RedTweezers from the University of Glasgow\index{Glasgow}. Martin Persson from Göteborgs Universitet also developed HOTlab\index{HOTlab} \cite{HOTLAB}, an open source software for Holographic Optical Tweezers. This project consists of two parts; a generating hologram library using \gls{cuda} and a \gls{gui} interface drawn in LabVIEW. HOTlab was last updated in November 2011 but only recent NVidia cards such as GeForce GTX285 \index{Nvidia}are compatible. Unfortunately we could not use his software with our old GPU.

Several other non-available user-interfaces were found on the internet or on published letters. However, all the interfaces found are designed with LabVIEW\index{LabVIEW}, a software that I would not recommend for any application. Graphic programming is an outdated idea that supports neither version control nor search/replace functionalities. Moreover, LabVIEW must be installed first in order to use one of these control interfaces.

\subsection{Red Tweezers}
\label{redtweezers}
Previously, the University of Glasgow released Blue Tweezers, a complete implementation of optical trapping drawn in LabVIEW. This project supports hologram generation algorithms \emph{i.e.} \gls{rm}, \gls{s}, \gls{sr} and \gls{gs}. As everything was implemented in a high level graphical programming, the performance aspect remains an issue. Hereafter, RedTweezers\index{RedTweezers} was released. This new version is composed of a LabView GUI which can include an image underlay from the microscope with a special version, a stand-alone OpenGL hologram engine which is probably using the SR algorithm. 

These two softwares are freely available under a \gls{gpl} license. The authors only request for them to be cited for any published academic work. 
...
\section{Hologram generation}
During the past five years, many researchers have tried to improve the hologram generation performances\index{performances}. They tried to minimize the overall phase change between frames which is more suitable for high stability requirement such as force measurement \cite{PERSSON2010}. They optimized their algorithms to generate holograms at faster frame rates and they designed new algorithms such as the weighted Gerchberg-Saxton. 

\subsection{Performances}
In the race for performance, developers realized they cannot use a \gls{pc} \gls{cpu} to compute hologram at high frame rates even if the implementation is done on a low level programming language (\gls{asm}, C). Nowadays, high performance Graphics Processing Units (\gls{gpu}) commonly used for video games or scientific computations feature a highly multi-core hardware. Their design is composed of hundreds of processor\index{processor} cores with a very fast access to a local and a global shared memory\index{memory}. 

The Open Graphics Library (OpenGL)\index{OpenGL}\index{DirectX} or DirectX is a cross-platform \gls{api} for writing applications that produce 2D and 3D graphics by using the computational power of GPUs. These libraries are more dedicated for making applications such as \gls{cad} software or computers games. In its basic operation, OpenGL accepts primitives such as points, lines and polygons and converts them into pixels via a graphics pipeline. 

NVidia, a graphics accelerator manufacturer realized that the computational power of their products can also be used for applications other than 3D rendering. A Compute Unified Device Architecture (\gls{cuda})\index{CUDA} was then developed to offer a more adapted architecture\index{architecture}\index{cryptography} for non-graphical applications like cryptography or computational biology. Recent versions of Matlab and Mathematica support for instance CUDA. As an example, Martin Persson's work uses CUDA to generate holograms with the \gls{gsw} algorithm. Unfortunately, if CUDA seems to be an established standard for scientific computation, computational compatibility is highly dependent on the graphic card used and only Nvidia cards are compatible. 

With this in mind, generating a hologram with OpenGL or DirectX is still something conceivable. However, only simple algorithms can be fully implemented. For instance, Red Tweezers use OpenGL to generate SR\index{Random Superposition} holograms.

\subsection{Pixel-shader}
\label{shader}
In the field of computer graphics, a shader is a program executed into a dedicated core on a GPU. This program is primarily loaded by the main application running on the CPU. There are three types of shaders in common use. Pixel shaders\index{pixel shader} also called fragment shaders that compute colors and other attributes of each pixel. They cannot produce very complex effects, because each shader operates only on a single pixel without knowledge of a scene's geometry. Vertex\index{vertex shader} shaders transform each vertex's 3D position in virtual space to the 2D coordinates at which it appears on the screen. A vertex is basically a data structure which describes a point in a three-dimensional space. Geometry shaders can generate new primitives such as points, lines and triangles. 

For hologram generation, a direct access to each pixel is preferred and pixel shaders can then be used. The programming of shaders depends on the target environment. With OpenGL, the shading language is OpenGL Shading Language (GLSL) \index{GLSL}that uses the syntax of C. 

\fig{shader2}{Pixel shader}

Basically, implementing a \gls{sr} algorithm\index{algorithm} on a pixel shader is not very complicated. As shown on figure \ref{shader2}, each pixel shader receives the pixel position and returns to its color. External parameters such as traps positions can be sent to the shader through uniforms, a type of global variable. An implementation of the SR algorithm has been done during this project and the source code is available in section \ref{glsl}.
...
An internal hologram generation using the SR algorithm was implemented using OpenGL. However, a recalcitrant bug creates\index{OpenGL} glitches on the hologram window when the traps are moved. As the time allowed for this application was limited, a \index{UDP}UDP socket was implemented in order to communicate with the stand-alone hologram generation program used by Red Tweezers. 

\section{Embedded system}
With a background in electronic engineering, I am surprised that an autonomous hologram generation systemdoes not exist. As discussed earlier, pixels shader offers an interesting base to compute a trapping hologram because they are working concurrently hence saving a lot of computation time. However, this approach is still very demanding in terms of computational resources. A recent GPU needs to be used with a complex CUDA application to achieve hologram generation of an iterative algorithm. Even with this, the frame rate is limited to few tens of hertz. 

A Field-programmable gate array (FPGA)\index{FPGA} is a programmable integrated circuit that can be very suitable for the integration of this kind of algorithm. For instance, independent computational units can be created on the basis of a shader structure. However, in this case the structure will be more specialized than a Turing machine. The Fresnel's forward and back propagation can be hard programmed in a non-sequential way which can increase the performance significantly. 

By using a dedicated platform to generate the SLM hologram\index{SLM}, it is possible to expect a high frame rate generation above \SI{200}{Hz} with thoughtful optimizations. For example, we noticed in our benchmark of algorithms efficiency that the algorithm that produces the better results depends strongly on the traps configuration and its symmetry. It can be worthwhile to choose the more adapted algorithm with regards to the trap configuration. 

Moreover, an embedded and dedicated platform may take the form of an external USB device with a DVI connector or better still, with a direct connection to a LCoS display.
\chapter{Discussion}
\section{Summary of Results}
All the initial goals set for this project have been met although we did not succeed in rotating and imaging an organic specimen under the VHIS because of an illumination issue which led to poor image quality. However, it can be inferred from the conducted experiments that it is still perfectly feasible to pursue our original goal. 

Escherichia coli was successfully rotated along an axis parallel with the trapping direction and micrometric spheres were rotated along an axis normal to the trapping direction. We demonstrated the trapping capabilities for spheres with diameters in the range of \SI{0.7}{\um} and \SI{15}{\um}. 

Optimized holograms were produced successfully with the help of Matlab and with the use of GPU for real-time trapping. In addition, SMART\index{SMART} has acquired knowledge of the usage and calibration of spatial light modulators. 

In addition, all the steps have been undertaken in order to make microfabricated SU-8 structures that would allow for holding and rotating a living cell. As we mentioned before, other research groups are also interested in \index{microfabrication}microfabrication for optical tweezers applications. Microelectromechanical systems are a very promising area and it is worthily of study its technological possibilities. SMART is very fortunate to have at its disposal a \index{NUS}NUS laboratory competent with two-photon photopolymerization\index{lithography} lithography. 

\section{Further investigations}
If it is decided that a volume holographic imaging system should continue to be used to achieve projected tomography of a complex phase object, it is necessary to improve the overall efficiency and image quality\index{VH} of the VH part. This can be achieved with the recording of a new thick hologram. 

However before taking this step, it may be worthwhile to try using only one objective lens for both trapping and imaging. In this way the design of the illumination part will be easier. 

We noted most biological materials only absorb weakly in the near-infrared region of the electromagnetic spectrum, hence moving to a near-infrared laser to achieve optical trapping is conceivable now. Moreover, inexpensive solid-state lasers can be found at 808 or \SI{1064}{\nm}. It can be also interesting to allow for dynamic adjustment of the laser power with regards to the number of traps. The laser can also be shut off when no traps are required. In the case of using an infrared laser, safety measures have to be taken. The SLM needs to be enclosed to block all the high orders of diffraction. 

Demonstrating trapping capabilities with a microfabricated structure is an extremely exciting goal. A first microstructure will be created when the new lithography setup from the Centre for Ion Beam Applications at NUS is ready and the subsequent actions taken from this has been detailed in section \ref{2ppactions}. 

We did not focus on the tomography part during this project. Although TIE and VHIS have been used together to retrieve phase information of organic specimens and TIE projected tomography was demonstrated for a macroscopic object, we cannot ensure VHIS TIE Tomography is a feasible solution. Therefore, I would suggest to spend more time and effort on this particular aspect of the project. Limited depth of field and poor telecentricity may be causes of concern as well. 

In addition, we observed during this project the importance of the Brownian movement for small objects in a colloidal solution. Good Radon transform can be achieved only if the  projections taken at different angles are acquired around a fixed axis. The Brownian force will induce slow vibrations on an optically trapped particle. By monitoring the trapped particle with a camera, a high speed feedback control loop can limit the amplitude of these vibration. 

Finally, an important part of this project was devoted to building a microscopy setup. Mechanical stability issues encouraged us to use more adapted optomechanical parts. However, our setup is still rather fragile in terms of stability and optical quality. Using a real microscope as a base for optical trapping should be the right solution, but such a microscope must be first obtained for this. 

\clearpage
\section{Conclusion}
Overall, the achieved goals from the various experiments throughout this project have met the requirements that were given in the beginning, and have resulted in a fairly functional optical setup. As a result of the way this project was structured, the final result is mostly a proof in concept that would require further investigations.
 
If this project is to be further developed, the factors mentioned above have to be taken into consideration. 

With regards to the optical tweezers portion, our expertise is now sufficient to guarantee the final feasibility of the project which is a rotation of an organic specimen along an axis perpendicular to the imaging direction. The same cannot be said for the VH system as the encountered issues are too important to be bypassed and a VHIS TIE projection tomography must first be demonstrated. 

As with every research project, an endless amount of investments could be made. Thereare many parameters which can be continuously improved on and a large number of ideas to experiment with. Thankfully, there was a definite goal set in place for this master's thesis i.e. to move particles simultaneously on different planes in the VH system. Nonetheless, the ultimate goal is to trap and rotate a cell to achieve projected tomography. In order to advance towards this goal, we have set in place an intermediate objective which was to rotate microspheres on the VH. We succeeded in this despite facing significant obstacles. In addition, SMART now has a good working knowledge of optical tweezers. Essentially, we achieved more than we initially planned for. 

In my opinion, microelectromechanical systems (MEMS) technology is the major breakthrough of the 21st century. With the new microfabrication techniques in the market that offer remarkable resolutions, we will soon be able to build microtools by the millions, contained in a colloidal solution. Without falling into the category of science fiction, it is a real possibility for the future biologist to be able to choose the appropriate vessel containing the type of tools needed. These tools will be used to manipulate living microorganisms with the help of optical tweezers. 

Realistically speaking, this project is on a promising path towards the above mentioned scenario. The small steps achieved during this master's project are an asset for SMART and could be the next big leap in science. 
...
Figure \ref{algos} shows the inputs and the outputs of each algorithm. The target is sparse matrixes containing the position of the different traps which are passed to the hologram generation function. A complex value is used to move the trap in the z-axis while the magnitude is related to the trap intensity, normalized to 1. \texttt{scale\_target} is a two-value array indicating the size of the target. \texttt{size\_hologram} give the dimensions of the output hologram in pixels and \texttt{pixel\_hologram} refers to the hologram pixel size. 
\label{algos}
...
\section{Random Mask}
\label{rmsource}
This random mask implementation has no loops which is preferred for use with Matlab. A matrix $R$ contains a random matrix containing an existing trap number. The hologram $H$ is generated by taking the phase value for each corresponding trap. 
\vfil
...
\subsection{GLSL}
\label{glsl}
This is the OpenGL implementation of a pixel shader. Uniforms passed to the shader are \texttt{SX} and \texttt{SY} is the position of each trap. \texttt{AC} is the number of active traps and \texttt{W} and \texttt{H} are the real sizes of the hologram. For compatibility reasons, it is not possible to dynamically adjust the size of \texttt{MAXNUMBERTRAPS}. This parameter has to be specified during the compilation. This means this current implementation is limited for a maximum of 20 traps. At the end, the pixel color is returned in $\texttt{gl\_FragColor.rgb}$. 
...
Invitrogen & \multicolumn{2}{|l|}{Fluorosphere \SI{10}{\um} F3386} \\ \hline
\end{tabularx}}

\section{Objective lenses}
{\small
\begin{tabularx}{\textwidth}{|p{5cm}|X|} \hline
\textbf{Model} & \textbf{Description} \\ \hline
Mitutuyo &Objective M Plan APO 20X NA 0.42 \\ \hline
Mitutuyo &Objective M Plan APO 10X NA 0.28 \\ \hline
Mitutuyo &Objective M Plan APO  5X NA 0.14 \\ \hline
Mitutuyo &Objective M Plan APO  2X \\ \hline
Olympus & ULWDMSPlan50X NA 0.55 f 3.6 mm \\ \hline
Olympus & UPLSAPO 100x NA 1.4 Oil \\ \hline
Newport & M-10x NA 0.25 WD 5.5 mm \\ \hline
Newport & M-20x NA 0.40 WD 1.7 mm \\ \hline
\end{tabularx}}

\section{Imaging devices}
{\small
\begin{tabularx}{\textwidth}{|p{5cm}|X|c|} \hline
\textbf{Model} & \textbf{Description} & \textbf{Serial} \\ \hline
Andor & Camera X-600 & X-6493/C6440 \\ \hline
Allied & Camera GE1650 1600x1200 & 02-207SC-06143 \\ \hline
Edmund & Color camera UI-1460SE-C 2048x1536 & - \\ \hline
\end{tabularx}}
\chapter{Custom mechanical parts}
\section{Hologram Holder}
This part is intended to be mounted on a Thorlabs LC1A swivel mount. This holder allow to move the hologram along an horizontal and vertical direction.\par 
\begin{center}
\includegraphics{fig/drwg-hologram.pdf}
\end{center}
\clearpage
\section{Calibration Mask}
This figure shows the mask used for the SLM calibration. This part was intended to be mount on a SM1 tube holder (SM1L0.5).\par
\begin{center}
\includegraphics{fig/mask.pdf}
\end{center}
\section{Light source holder}
These two parts allowed for mounting the end of the Zeiss light inside a SM1 tube holder (SM1L10). They were printed with the SMART 3D printer.\par 
\label{partlight}
\includegraphics[width=\textwidth]{fig/drwg-light.pdf}

\chapter{Practical tricks}
\section{Telescope alignment}
Alignment of a laser beam into a specified optical path needs some degree of freedom. For instance, you would not use fixed post if possible. It is always better to be able to slightly move the setup on the optical table if necessary. Also, it is more convenient to split an optical setup on different parts linked together with mirrors. Each individual part can be adjusted and moved without compromising the whole setup.

The the configuration below shows two steering mirrors used to align the beam inside the telescope. Here the lenses have been removed and two alignment tools (CPA1 and SM1A7) are used. We note both the upstream screw and the downstream screw can move the beam.\par
\includegraphics[width=\textwidth]{fig/alignment1.pdf}
The alignment procedure starts by centering the beam in the middle of the CPA1 (a). This alignment target has a small hole in the middle and allows for the beam to continue and hit the second target. When not aligned, the beam does not hit the middle of the second target as seen on the figure (b). The downstream screw is used to bring the beam to the middle of the target. Then the beam is again not aligned with the first target (c). The upstream steering mirror is adjusted again to center the beam. The cycle is repeated until the beam is align on both target. Finally, the lenses can be replaced on the telescope.\par
\includegraphics[width=\textwidth]{fig/alignment2.pdf}

\section{Base Adapters}
A poor initial choice in the base adapters for an optical setup can lead to a lot of trouble when the setup has to be slightly modified. The combination of a round base and a clamping fork is the more versatile solution (a). The component can be move freely on the optical table. The BA2T2 base adapter is suitable for inline setups such as telescopes (b). However, the BA1 should not be used in combination with a BA2T2 (c). The UPH1.5 (d) provides a better rigidity than the solution (a) but is a little bit more complicated to move. Finally, the direct mount (e) should not be used except on certain specific case.

All these parts come from Thorlabs Inc.\par 
\includegraphics[width=\textwidth]{fig/posts.pdf}

\section{1951 USAF Target}
The 1951 USAF resolution test chart is a resolution test pattern set by US Air Force in 1951. It is a common resolution pattern in optics. The microscope versions are chromium coated on a glass substrate. It exists a positive and a negative version in Thorlabs. Both offer a resolution down to 288 lines per millimeter.  
\subsection{Finding the smallest group}
It is always tough to find the smallest group when used with a high magnification microscope. However, a method allows to considerably reducing the time spent. Firstly, we notice the block numbers are always located at the side of horizontal lines (a) and the group numbers are located above vertical (b) or horizontal lines (c). Secondly we notice a smaller pattern is always located at a vertical position that is in between the block numbers 3 and 4 (d). 

\includegraphics[width=\textwidth]{fig/1951.pdf}
\includegraphics[width=\textwidth]{fig/1951-2.pdf}

Here we randomly started on the edge of the top horizontal line group -4 block 2. By moving on the left we notice there is a number, too big to be seen. It is obviously a block number. By moving the target on the right we will find the opposite block number belongs to a smaller group. Here we can read 1 then we go down to a position between 3 and 4 and we move left again to find the smaller pattern. Again we find the 3 and 4 until we find the smaller group.
\clearpage 
\subsection{Obtain group size and resolution}
The documentation that comes with the targets are usually not very clear. The notion of line-pair should be called instead spatial period.\par 
...
A glass coated target is often used in the wrong way. It has to be used in the coated side. By observing the orientation of the group and element numbers and the side of the resolution target it is possible to make sure the orientation is correct.\par 
\includegraphics[width=\textwidth]{fig/1951-4.pdf}

\chapter{Experimental setup pictures}
\section{Shear Plate}
Beam quality evaluation on a shear interferometer. The fringed aligned with the black line on the screen indicate a good beam alignment.\par 
\includegraphics[width=\textwidth]{pic/shear.pdf}

\clearpage
\section{Hologram Holder}
Overview of the swivel 60 mm cage system rotation stage with the home made hologram holder. The incoming beam comes from the left and it is deviated by the hologram on the visible relay lens.\par
\includegraphics[width=\textwidth]{pic/holo.pdf}

\section{Imaging quality on the VH}
100\% scale acquisition of the target group 7 with the VH prior to be mounted to the tweezers setup.\par 
\includegraphics[width=\textwidth]{pic/vhres.pdf}

\clearpage
\section{Volume Holographic Imaging System}
First implementation of the VH on the tweezers part. We can observe the GE-1650 camera and the second pole with a vertical translating stage to help the alignment.\par 
\includegraphics[width=\textwidth]{pic/vh.pdf}

\section{Interferences on the first VH}
When we used a beam splitter on the right angle relay, we could observe some interference pattern after the relay due to the internal reflexions inside the beam spliter.\par 
\includegraphics[width=\textwidth]{pic/interf.pdf}

\section{Sample on the 3-axis stage}
Sample mounted on the 3-axis stage with the trapping laser on.\par 
\includegraphics[width=\textwidth]{pic/image.pdf}



\section{VH + HOT Setup}
Final setup including the HOT and the VHIS.\par 
\includegraphics[width=\textwidth]{pic/vhtw.pdf}

\section{Sample}
Sample composed of a two double side adhesive tape, a cover glass and a glass slit. This sample contain \SI{15}{\um} fluorescent spheres.\par
\includegraphics[width=\textwidth]{pic/sample.pdf}
...
All the diagrams and illustrations in this report were created with Adobe Illustrator CS5 and Adobe Photoshop CS5. The three-dimensional views were made using SolidWorks 2012 and the curves were generated with Matlab. All the figures were converted in PDF files. 

This document was compiled with pdflatex and bibtex using vim and vim-latex. The bibliography was managed with JabRef.
